...
public class MobSetPantsCommand extends DeityCommandReceiver {
	...
	public boolean onPlayerRunCommand(Player player, String[] args) {
		...
		Material material = DungeonManager.getMaterialByName(args[0], "LEGGINGS");
		
		if(material == null) {
			DeityAPI.getAPI().getChatAPI().sendPlayerMessage(player, "DeityDungeons", "Invalid material.");
		}
		
		DungeonManager.setMobAttribute(DungeonManager.getPlayersMob(player), "pants", material.getId());
