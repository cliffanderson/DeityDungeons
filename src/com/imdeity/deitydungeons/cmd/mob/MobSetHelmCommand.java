...
public class MobSetHelmCommand extends DeityCommandReceiver {
	...
	public boolean onPlayerRunCommand(Player player, String[] args) {
		...
		Material material = DungeonManager.getMaterialByName(args[0], "HELMET");
		
		if(material == null) {
			DeityAPI.getAPI().getChatAPI().sendPlayerMessage(player, "DeityDungeons", "Invalid material.");
		}
		
		DungeonManager.setMobAttribute(DungeonManager.getPlayersMob(player), "helm", material.getId());
