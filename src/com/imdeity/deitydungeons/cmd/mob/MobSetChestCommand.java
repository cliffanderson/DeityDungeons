...
public class MobSetChestCommand extends DeityCommandReceiver {
	...
	public boolean onPlayerRunCommand(Player player, String[] args) {
		...
		Material material = DungeonManager.getMaterialByName(args[0], "CHESTPLATE");
		
		if(material == null) {
			DeityAPI.getAPI().getChatAPI().sendPlayerMessage(player, "DeityDungeons", "Invalid material.");
		}
		
		DungeonManager.setMobAttribute(DungeonManager.getPlayersMob(player), "chest", material.getId());
